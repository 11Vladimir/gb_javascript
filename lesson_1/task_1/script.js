...
function userTemperatur() {
    let celsiusTemperatur = +prompt("Введите температуру в Цельсьях: ");
    alert (celsiusTemperatur + " Градусов по Цельсию = " + ((9 / 5) * celsiusTemperatur + 32) + "F");
}
